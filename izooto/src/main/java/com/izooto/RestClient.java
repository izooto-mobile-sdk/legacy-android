...
public class RestClient {
        ...
        try {
            ...
            if (httpResponse == HttpURLConnection.HTTP_OK) {
                ...
                if (inputStream != null) {
                    ...
                    Lg.w(AppConstant.APP_NAME_TAG, AppConstant.APP_NAME_TAG);
            ...
            if (t instanceof java.net.ConnectException || t instanceof java.net.UnknownHostException)
                ...
                Lg.w(AppConstant.APP_NAME_TAG, AppConstant.EXCEPTIONERROR + method , t);
    ...
    static class ResponseHandler {
        void onSuccess(String response) {
            Lg.d(AppConstant.APP_NAME_TAG, AppConstant.SUCCESS + response);
        }

        void onFailure(int statusCode, String response, Throwable throwable) {
            Lg.e(AppConstant.APP_NAME_TAG, AppConstant.FAILURE + response);
        }
    }
}
