...
public class iZooto {
    ...
    public static void registerToken() {
        ...
        if (!preferenceUtil.getBoolean(AppConstant.IS_TOKEN_UPDATED)) {
            ...
            String api_url = AppConstant.APP + AppConstant.STYPE + AppConstant.PID + mIzooToAppId + AppConstant.BTYPE_ + AppConstant.BTYPE + AppConstant.DTYPE_ + AppConstant.DTYPE + AppConstant.TIMEZONE + System.currentTimeMillis() + AppConstant.BVERSION + appVersion +
                    AppConstant.OS + AppConstant.SDKOS + AppConstant.ALLOWED_ + AppConstant.ALLOWED + AppConstant.TOKEN + preferenceUtil.getStringData(AppConstant.FCM_DEVICE_TOKEN) + AppConstant.CHECK+Util.getSDKVersion();
            ...
            try {
                ...
                api_url += AppConstant.OSVERSION + osVersion + AppConstant.DEVICENAME + deviceName;
